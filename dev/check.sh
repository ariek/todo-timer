...
required = [
    ...
    'measureInsets', 'registerServiceWorker', 'waitInstalled', 'renderSessionModals', 'renderHeader', 'linkifyHtml', 'initSwipeBack', 'slideInTasks', 'slideOutTasks', 'renderOverview', 'initOverview', 'openTasks', 'showCategoryList', 'updateFabs', 'hideSheet', 'showSheet', 'sheetJustClosed', 'showPage', 'hidePage', 'fadeInSession', 'noteBtn', 'showNoteModal', 'hideNoteModal', 'markEnteringRows', 'leaveRow', 'unfold', 'settleRow', 'focusSnapshot', 'swapFocusCard', 'bumpFocusCard', 'saveScreen', 'loadScreen', 'categoryIconHtml', 'categoryColorHex', 'categoryIconId', 'injectCategoryIcons', 'renderPickers', 'nextFreeColor',
