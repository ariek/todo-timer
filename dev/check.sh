...
required = [
    ...
    'measureInsets', 'registerServiceWorker', 'waitInstalled', 'renderSessionModals', 'renderHeader', 'linkifyHtml', 'initSwipeBack', 'slideInTasks', 'slideOutTasks', 'renderOverview', 'initOverview', 'openTasks', 'showCategoryList', 'updateFabs', 'hideSheet', 'showSheet', 'riseView', 'sinkView', 'saveScreen', 'loadScreen', 'categoryIconHtml', 'categoryColorHex', 'categoryIconId', 'injectCategoryIcons', 'renderPickers', 'nextFreeColor',
